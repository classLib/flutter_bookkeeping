...
import 'categorySettingTest.dart';
...
class CategoryExpenditureAdd extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return new _CategoryExpenditureAddState();
  }
}

class _CategoryExpenditureAddState extends State<CategoryExpenditureAdd> {
  // 默认的图片编号为1
  var curImageNum;
  var curImage;
...
//  初始化状态
  ...
  List<Widget> _listView(context) {
    ...
    // 遍历全局图片组件生成对应的weight
    CategoryImageNum.expenditureIamgeList.map((e) => {listWidget.add(listItem(e))}).toList();
    return listWidget;
  }
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Image.asset(
            curImageNum == 1 ? 'assets/canyin.png' : curImage,
            width: 40,
            height: 40,
          ),
        ),
